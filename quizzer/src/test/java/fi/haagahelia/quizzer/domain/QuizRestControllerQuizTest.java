...
public class QuizRestControllerQuizTest {
    ...
    public void getAllQuizzesDoesNotReturnUnpublishedQuizzes() throws Exception {
        ...
        Quiz unpublishedQuiz = new Quiz(null, "Unpublished Quiz", "This is not published", false, LocalDate.now(), null);
        Quiz unpublishedQuiz2 = new Quiz(null, "Unpublished Quiz 2", "This is not published", false, LocalDate.now(), null);
